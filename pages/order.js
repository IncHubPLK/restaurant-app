...
const  Order= ({route,navigation}) => {
    ...
    return ( 
        ...
        <View style={styles.wrapper}>
            ...
            <Text style={{fontSize:27,fontWeight:600, color: '#28DE83'}}>Preparing your order...</Text>
            </View>
            <TouchableOpacity style={{marginTop:20,}}><Text style={{ color: '#E10600'}}>Make a New Order</Text></TouchableOpacity>

  ...
  return ( 
      ...
      >
        ...
        <Image
          ...
          style={{width:16,height:16,marginLeft:'auto',marginRight:'auto'}}
        />
      ...
      <View style={styles.wrapper}>
         ...
         <Text style={{fontSize:24,fontWeight:400,marginLeft:'-80%'}}>Cart</Text>
      ...
      renderItem={({item,i}) =>(
          ...
          <Image
          source={item.image} style={{width:80,height:80,borderRadius:50}}/>
         <View style={{alignItems:'center'}}>
         <Text style={{fontSize:22,fontWeight:700}}>{item.name}</Text>
          <Text style={{fontSize:18,fontWeight:300, color:'#28DE83'}}>R{item.price}.00</Text>
         </View>
          <View>
          <Text style={{fontSize:28,fontWeight:700}}></Text>
          <Text style={{fontSize:18,fontWeight:700, color:'#E10600'}}>{item.quantity}</Text>
          <Text style={{fontSize:28,fontWeight:700}}></Text>
          </View>
      </View>
      )} style={{width:'100%'}}/> 
      ...
      <View style={styles.bottomView}>
        <Text style={{color:'#28DE83',fontSize:18,fontWeight:500,marginLeft:80,marginTop:20}}>R {total}.00</Text>
